...
function start(id_type) {
    ...
    function() {
        ...
        if (e.includes("detail") || e.includes("detail/uz") || e.includes("detail/en")) {
    ...
    (Z.includes("catalog") || Z.includes("catalog/uz") || Z.includes("catalog/en")) && fetch("/files/products.json").then((e => e.json())).then((e => {
        e1 = e
        Z1 = Z
        ee1 = ee
        sortCategory()
    ...
    ("/"===Z||Z.includes("main")||Z.includes("detail")||"/main/uz.html"===Z||Z.includes("main/en.html")||Z.includes("detail.html")||Z.includes("detail/uz.html")) && fetch("/files/products.json").then((e => e.json())).then((e => {
        ...
        e.forEach((e => {
            ...
            n = Z.includes("-en") ? 
                `detail-en.html?id=${e.id}` : Z.includes("-uz") ? 
                    `detail-uz.html?id=${e.id}` : `detail.html?id=${e.id}`,
                    s.innerHTML = `\n                    
        ...
        s.classList.add("catalog__item"),
            i = e.count ? "en" === ee1 ? e.weight.map((t => `
                ...
                `<h3>${t} test g / ${e.count} dona</h3>`)).join("") : e.weight.map((t =>
                    `<h3>${t} test2 г / ${e.count} шт</h3>`)).join("") : e.weight.map((e =>
                        `<h3>${e} test3 г</h3>`)).join(""),
            n = Z1.includes("-en") ? `detail/en?id=${e.id}` : Z1.includes("-uz") ? `detail/uz?id=${e.id}` : `detail?id=${e.id}`,
