    ...
    listPro.forEach((e => {
        ...
        s.classList.add("catalog__item"),
            i = e.count ? "/en" === ee1 ? e.weight.map((t => `
                <h3>${t} g / ${e.count} pcs</h3>`)).join("") : "/uz" === ee1 ? e.weight.map((t =>
                `<h3>${t} test g / ${e.count} dona</h3>`)).join("") : e.weight.map((t =>
                    `<h3>${t} г / ${e.count} шт</h3>`)).join("") : e.weight.map((e =>
                        `<h3>${e} г</h3>`)).join(""),
            ...
            s.innerHTML = `\n                  
                ...
                <h3 class="catalog__item-title">${e?.type?.[ee1] ? e?.type?.[ee1] : "/en"} «${e?.name?.[ee1]}»</h3>\n                      
