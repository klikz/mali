function start () {
        ...
        for (let n = 1; n < e.length; n += 1) {
            ...
            !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    ...
                    void 0 !== n && n.enumerable && (g(t[i]) && g(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : v(t[i], a[i]) : !g(t[i]) && g(a[i]) ? (t[i] = {},
                    a[i].__swiper__ ? t[i] = a[i] : v(t[i], a[i])) : t[i] = a[i])
                }
            }
        }
        var i;
    ...
    const E = {
      ...
      , x = {
        ...
        updateSlides: function() {
            ...
            if (void 0 === a)
                return;
            "string" == typeof S && S.indexOf("%") >= 0 && (S = parseFloat(S.replace("%", "")) / 100 * a),
            "string" == typeof S && S.indexOf("vw") >= 0 && (S = parseFloat(S.replace("vw", "")) / 100 * window.innerWidth),
            e.virtualSize = -S,
            r ? c.css({
                marginLeft: "",
                marginBottom: "",
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                "none" !== r.css("display")) {
                    ...
                    m.push(x),
                    i.centeredSlides ? (C = C + x / 2 + T / 2 + S,
                    0 === T && 0 !== n && (C = C - a / 2 - S),
                    0 === n && (C = C - a / 2 - S),
                    Math.abs(C) < .001 && (C = 0),
                    ...
                    (y - Math.min(e.params.slidesPerGroupSkip, y)) % e.params.slidesPerGroup == 0 && u.push(C),
                    h.push(C),
                    C = C + x + S),
                    e.virtualSize += x + S,
                    T = x,
            ...
            i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) {
                ...
                w(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
    ...
    const k = {
        ...
        slidePrev: function(e=this.params.speed, t=!0, s) {
            ...
            "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && (m = m - i.slidesPerViewDynamic("previous", !0) + 1,
            m = Math.max(m, 0))),
            n.rewind && i.isBeginning ? i.slideTo(i.slides.length - 1, e, t, s) : i.slideTo(m, e, t, s)
        },
    ...
    function L(e) {
        ...
        if (l.noSwiping && (m ? function(e, t=this) {
            return function t(s) {
                return s && s !== i() && s !== a() ? (s.assignedSlot && (s = s.assignedSlot),
        ...
        "touchstart" !== c.type) {
            ...
            s.activeElement && h(s.activeElement).is(r.focusableElements) && s.activeElement !== p[0] && s.activeElement.blur();
    ...
    function M(e) {
        ...
        if (void 0 === n.isScrolling) {
            let e;
            s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? n.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI,
        ...
        n.isMoved || (a.loop && !a.cssMode && s.loopFix(),
        ...
        a.resistance && (n.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + n.startTranslate + v) ** b)) : v < 0 && n.currentTranslate < s.maxTranslate() && (w = !1,
        a.resistance && (n.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - n.startTranslate - v) ** b)),
    ...
    function P(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (g >= i.longSwipesRatio ? t.slideTo(u + v) : t.slideTo(u)),
            "prev" === t.swipeDirection && (g > 1 - i.longSwipesRatio ? t.slideTo(u + v) : t.slideTo(u))
        } else {
            if (!i.shortSwipes)
                return void t.slideTo(t.activeIndex);
            !t.navigation || o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(u + v),
            "prev" === t.swipeDirection && t.slideTo(u)) : o.target === t.navigation.nextEl ? t.slideTo(u + v) : t.slideTo(u)
        }
    }
    function O() {
        const e = this
    ...
    const G = (e, t) => {
      ...
      , B = {
        attachEvents: function() {
            ...
            e.onClick = z.bind(e),
            n.touch && !I && (t.addEventListener("touchstart", D),
            I = !0),
            G(e, "on")
        },
            ...
            i.device = function(e={}) {
                return C || (C = function({userAgent: e}={}) {
                    ...
                    const p = n.match(/(iPod)(.*OS\s([\d_]+))?/)
                      ...
                      , h = "Win32" === i;
                    let m = "MacIntel" === i;
                    return !c && m && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/),
                    c || (c = [0, 1, "13_0_0"]),
                    m = !1),
                    d && !h && (r.os = "android",
                    r.android = !0),
    ...
    function K({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function d() {
            ...
            "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                ...
                s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (r += c - (e.previousIndex - e.loopedSlides || 0),
            ...
            if ("fraction" === s.type && (d.find(U(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            d.find(U(s.totalClass)).text(s.formatFractionTotal(p))),
            "progressbar" === s.type) {
                let t;
                ...
                d.find(U(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(e.params.speed)
            }
        ...
        function c() {
            ...
            if ("bullets" === t.type) {
                ...
                n.html(a),
                e.pagination.bullets = n.find(U(t.bulletClass))
            }
        ...
        s("click", ( (t, s) => {
            const n = s.target
              , {$el: a} = e.pagination;
            if (e.params.pagination.el && e.params.pagination.hideOnClick && a.length > 0 && !h(n).hasClass(e.params.pagination.bulletClass)) {
    ...
    let Z = window.location.pathname
      , ee = "";
    function te(e) {
        let t = window.location.href;
        const s = /-(ru|uz|en)\.html/
          , i = /\/$/
          , n = /\.html$/;
        if (t !== window.location.origin + "/" && t !== window.location.origin)
            if ("ru" === e)
                if (s.test(t)) {
                    const e = t.replace(s, ".html");
                    window.location.href = e
                } else if (i.test(t)) {
                    const e = t.replace(i, ".html");
                    window.location.href = e
                } else
                    n.test(t) ? window.location.href = t : window.location.href = t.replace(/\/$/, "") + ".html";
            else {
                let a;
                a = s.test(t) ? t.replace(s, `-${e}.html`) : n.test(t) ? t.replace(n, `-${e}.html`) : i.test(t) ? t.replace(i, `-${e}.html`) : t.replace(/\/$/, `-${e}.html`),
                console.log(a),
                window.location.href = a
            }
        else
            window.location.href = "ru" === e ? "/index.html" : `/index-${e}.html`
    }
    ee = Z.includes("-en") ? "en" : Z.includes("-uz") ? "uz" : "ru";
    const se = document.querySelector(".ru")
      , ie = document.querySelector(".uz")
      , ne = document.querySelector(".en");
    se && se.addEventListener("click", (function(e) {
        e.preventDefault(),
        te("ru")
    }
    )),
    ie && ie.addEventListener("click", (function(e) {
        e.preventDefault(),
        te("uz")
    }
    )),
    ...
    function() {
        let e = window.location.pathname
          , t = "";
        t = e.includes("-en") ? "en" : e.includes("-uz") ? "uz" : "ru";
        const s = {
            uz: "Og'irlig donaga",
            ru: "Вес шт",
            en: "Weight per piece"
        ...
        if (e.includes("detail.html") || e.includes("detail-uz.html") || e.includes("detail-en.html")) {
            const e = document.getElementById("goBackButton");
            e && e.addEventListener("click", ( () => {
                window.history.back()
            }
            ));
            const o = new URLSearchParams(window.location.search).get("id");
            o ? fetch("/files/products.json").then((e => e.json())).then((e => {
                const d = e.find((e => e.id == o))
                  , c = "img/products/";
                d ? (document.querySelectorAll(".detail__img-main img").forEach((e => {
                    e.src = c + d.img
                }
                )),
                document.querySelector(".detail__img-item img").src = c + d.img,
                document.querySelector(".swiper-wrapper").innerHTML = "",
                document.querySelector(".detail__item-type").textContent = d?.type?.[t],
                document.querySelector(".detail__item-name").textContent = d?.name?.[t],
                document.querySelector(".detail__item-info").textContent = d?.info[t],
                d.compound ? document.querySelectorAll(".compound .detail__info-content p").forEach((e => {
                    e.textContent = d.compound[t]
                }
                )) : document.querySelectorAll(".compound").forEach((e => e.remove())),
                d.energy_value ? document.querySelectorAll(".energy_value .detail__info-content p").forEach((e => {
                    e.textContent = d.energy_value + ("en" === t ? " kcal" : "uz" === t ? " kkal" : " ккал")
                }
                )) : document.querySelectorAll(".energy_value").forEach((e => e.remove())),
                d.nutritional_value ? document.querySelectorAll(".nutritional_value .detail__info-content p").forEach((e => {
                    e.textContent = d.nutritional_value[t]
                }
                )) : document.querySelectorAll(".nutritional_value").forEach((e => e.remove())),
                document.querySelectorAll(".detail__options").forEach(( (e, o) => {
                    e.innerHTML = "",
                    d.pack && d.pack.list && (d.pack.list.forEach(( (o, d) => {
                        const c = document.createElement("li");
                        c.classList.add("detail__options-item"),
                        0 === d && c.classList.add("active"),
                        c.innerHTML = `\n                  <h3 class="detail_options-title">${o?.type?.[t] ?? ""}</h3>\n                  <ul class="detail__options-list">\n                    ${o.weight ? `\n                      <li class="detail__options-el">\n                        <h4>${a?.[t] ?? ""}</h4>\n                        <h3>${o.weight} ${"en" === t || "uz" === t ? "g" : "г"}</h3>\n                      </li>` : ""}\n                    ${o.weight_big ? `\n                      <li class="detail__options-el">\n                        <h4>${a?.[t] ?? ""}</h4>\n                        <h3>${o.weight_big} ${"en" === t || "uz" === t ? "kg" : "кг"}</h3>\n                      </li>` : ""}\n                    ${o.inpack ? `\n                      <li class="detail__options-el">\n                        <h4>${n?.[t] ?? ""}</h4>\n                        <h3>${o.inpack} ${"en" === t ? "pcs" : "uz" === t ? "dona" : "шт"}</h3>\n                      </li>` : ""}\n                    ${o.box ? `\n                      <li class="detail__options-el">\n                        <h4>${i?.[t] ?? ""}</h4>\n                        <h3>${o.box} ${"en" === t ? "pkg" : "uz" === t ? "pkt" : "уп"}</h3>\n                      </li>` : ""}\n                    ${o.in_container ? `\n                      <li class="detail__options-el">\n                        <h4>${l?.[t] ?? ""}</h4>\n                        <h3>${o.in_container} ${"en" === t ? "pcs" : "uz" === t ? "dona" : "шт"}</h3>\n                      </li>` : ""}\n                    ${o.box_weight ? `\n                      <li class="detail__options-el">\n                        <h4>${s?.[t] ?? ""}</h4>\n                        <h3>${o.box_weight} ${"en" === t ? "kg" : "uz" === t ? "pkt" : "кг"}</h3>\n                      </li>` : ""}\n                      ${o.inbox ? `\n                      <li class="detail__options-el">\n                        <h4>${r?.[t] ?? ""}</h4>\n                        <h3>${o.inbox} ${"en" === t ? "pcs" : "uz" === t ? "dona" : "шт"}</h3>\n                      </li>` : ""}\n                  </ul>\n                  `,
                        e.appendChild(c)
                    }
                    )),
                    e.querySelectorAll(".detail__options-item").forEach((t => {
                        t?.addEventListener("click", ( () => {
                            t.classList.contains("active") || (e.querySelectorAll(".detail__options-item").forEach((e => e.classList.remove("active"))),
    ...
    (Z.includes("catalog/ru") || Z.includes("catalog/uz") || Z.includes("catalog/en")) && fetch("/files/products.json").then((e => e.json())).then((e => {
        e = e.filter((e => e.img));
        const t = document.querySelector(".catalog__list");
        e.forEach((e => {
            const s = document.createElement("li");
            let i, n;
            s.classList.add("catalog__item"),
            i = e.count ? "en" === ee ? e.weight.map((t => `<h3>${t} g / ${e.count} pcs</h3>`)).join("") : "uz" === ee ? e.weight.map((t => `<h3>${t} g / ${e.count} dona</h3>`)).join("") : e.weight.map((t => `<h3>${t} г / ${e.count} шт</h3>`)).join("") : e.weight.map((e => `<h3>${e} г</h3>`)).join(""),
            n = Z.includes("-en") ? `detail-en.html?id=${e.id}` : Z.includes("-uz") ? `detail-uz.html?id=${e.id}` : `detail.html?id=${e.id}`,
            s.innerHTML = `\n                  <a href="${n}" class="catalog__item-link">\n                    <div class="catalog__item-top">\n                      <div class="catalog__item-zone">\n                        <span class="active"></span>\n                      </div>\n                      <div class="catalog__item-img">\n                        <img src="${"/img/products/" + e.img}" alt="${e?.name?.[ee]}" class="active">\n                      </div>\n                      <div class="catalog__item-pagination">\n                        <span class="active"></span>\n                      </div>\n                    </div>\n                    <div class="catalog__item-box">\n                      <h3 class="catalog__item-title">${e?.type?.[ee] ? e?.type?.[ee] : ""} «${e?.name?.[ee]}»</h3>\n                      <p class="catalog__item-text">${e.info[ee]}</p>\n                      <div class="catalog__item-bottom">\n                        ${i}\n                      </div>\n                    </div>\n                  </a>\n                `,
            t.appendChild(s)
        }
        ))
    }
    ...
    ("/" === Z || Z.includes("index.html") || Z.includes("detail.html") || "/index-uz.html" === Z || Z.includes("index-en.html") || Z.includes("detail.html") || Z.includes("detail-uz.html")) && fetch("/files/products.json").then((e => e.json())).then((e => {
        e = (e = e.filter((e => e.img))).slice(0, 10);
        const t = document.querySelector(".productSwiper .swiper-wrapper");
        t.innerHTML = "",
        e.forEach((e => {
            const s = document.createElement("div");
            let i, n;
            s.classList.add("swiper-slide"),
            i = e.count ? "en" === ee ? e.weight.map((t => `<h3>${t} g / ${e.count} pcs</h3>`)).join("") : "uz" === ee ? e.weight.map((t => `<h3>${t} g / ${e.count} dona</h3>`)).join("") : e.weight.map((t => `<h3>${t} г / ${e.count} шт</h3>`)).join("") : e.weight.map((e => `<h3>${e} ${"en" === ee || "uz" === ee ? "g" : "г"}</h3>`)).join(""),
            n = Z.includes("-en") ? `detail-en.html?id=${e.id}` : Z.includes("-uz") ? `detail-uz.html?id=${e.id}` : `detail.html?id=${e.id}`,
            s.innerHTML = `\n                    <a href="${n}" class="product__item">\n                      <div class="product__item-img">\n                        <img loading="lazy" src="${"img/products/" + e.img}" alt="${e?.name?.[ee]}">\n                      </div>\n                      <div class="product__item-box">\n                        <h3 class="product__item-title">${e.type[ee]} ${e?.name?.[ee] ? `«${e.name[ee]}»` : ""}\n                        </h3>\n                        <p class="product__item-text">${e.info[ee]}</p>\n                        <div class="product__item-bottom">\n                          ${i}\n                        </div>\n                      </div>\n                    </a>\n                  `,
            t.appendChild(s)
        }
        )),
        t.childElementCount > 0 && new R(".productSwiper",{
            navigation: {
    ...
    const ae = document.querySelector(".header__bar-exit")
      , re = document.querySelector(".header__bar")
    ...
    const oe = document.querySelector(".catalog__side")
      , de = document.querySelectorAll(".catalog__side-close")
      , ce = document.querySelector(".catalog__header-filter");
    de.forEach((e => {
    ...
    document.querySelectorAll(".catalog__item-top").forEach((e => {
        const t = e.querySelectorAll(".catalog__item-pagination span")
          , s = e.querySelectorAll(".catalog__item-zone span")
          , i = e.querySelectorAll(".catalog__item-img img");
        s.forEach(( (s, n) => {
            s?.addEventListener("mouseenter", ( () => {
                e.querySelector(".catalog__item-img img.active").classList.remove("active"),
                e.querySelector(".catalog__item-pagination span.active").classList.remove("active"),
                e.querySelector(".catalog__item-zone span.active").classList.remove("active"),
    ...
    document.querySelectorAll(".search__item-top").forEach((e => {
        const t = e.querySelectorAll(".search__item-pagination span")
          , s = e.querySelectorAll(".search__item-zone span")
          , i = e.querySelectorAll(".search__item-img img");
        s.forEach(( (s, n) => {
            s?.addEventListener("mouseenter", ( () => {
                e.querySelector(".search__item-img img.active").classList.remove("active"),
                e.querySelector(".search__item-pagination span.active").classList.remove("active"),
                e.querySelector(".search__item-zone span.active").classList.remove("active"),
                i[n].classList.add("active"),
                t[n].classList.add("active"),
                s.classList.add("active")
            }
    ...
    const pe = document.querySelectorAll(".catalog__select-btn")
      , ue = document.querySelectorAll(".catalog__select")
      , he = document.querySelectorAll(".catalog__select-content")
      , me = document.querySelectorAll(".catalog__select-arrow");
    for (let e = 0; e < pe.length; e++)
        pe[e]?.addEventListener("click", ( () => {
            he[e].classList.toggle("active"),
            pe[e].classList.toggle("active"),
            ue[e].classList.toggle("active"),
            me[e].classList.toggle("active"),
            he[e].classList.contains("active") ? he[e].style.minHeight = he[e].scrollHeight + "px" : he[e].style.minHeight = "0"
        }
        ));
    const fe = document.querySelectorAll(".detail__info-btn")
      , ge = document.querySelectorAll(".detail__info-content");
    for (let e = 0; e < fe.length; e++)
        fe[e]?.addEventListener("click", ( () => {
            ge[e].classList.toggle("active"),
            fe[e].classList.toggle("active"),
            ge[e].classList.contains("active") ? ge[e].style.minHeight = ge[e].scrollHeight + "px" : ge[e].style.minHeight = "0"
        }
        ))
}
start()

function test(id_type){
    start()
}